...
tabla_SO2_estacion <- datos_finales %>%
  group_by(Estacion) %>%
  summarise(
    n = sum(!is.na(SO2)),
    ...
    Minimo = min(SO2, na.rm = TRUE),
    Maximo = max(SO2, na.rm = TRUE),
    Rango = Maximo - Minimo,
    
    Varianza = var(SO2, na.rm = TRUE),
    Desv_Estandar = sd(SO2, na.rm = TRUE),
    
    Q1 = quantile(SO2, 0.25, na.rm = TRUE),
    Q3 = quantile(SO2, 0.75, na.rm = TRUE),
    IQR = IQR(SO2, na.rm = TRUE),
    
    P90 = quantile(SO2, 0.90, na.rm = TRUE),
    P95 = quantile(SO2, 0.95, na.rm = TRUE),
