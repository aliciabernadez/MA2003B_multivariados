...
```{r}
# Seleccionar las estaciones de interés de acuerdo con el objetivo
datosE <- datos %>%
  filter(Estacion %in% c("NE", "SE2", "SE3"))

# Revisar la base seleccionada
dim(datosE)
table(datosE$Estacion, datosE$Año)
```
