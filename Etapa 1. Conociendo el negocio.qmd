...
| `SO2` | Concentración de dióxido de azufre | Numérica | 0–405 ppb | 3.45% | Variable principal |
| `WDR` | Dirección del viento | Numérica | $0^\circ$–$360^\circ$ | 2.17% | Identificar dirección de origen |
...
| `Estacion` | Estación de monitoreo | Categórica | NE, SE2, SE3 | 0.00% | Comparar ubicaciones |
