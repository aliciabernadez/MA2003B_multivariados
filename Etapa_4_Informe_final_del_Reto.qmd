...
SE3 es la estación más cercana al complejo refinador y presenta un azimut de 87.3°, correspondiente al Este, mientras que SE2 y NE permiten evaluar la atenuación de la señal conforme aumenta la distancia. GAR, ubicada a 68.5 km, se utiliza como estación de control.
Las cuatro estaciones tienen el complejo hacia el Este o Este-Sureste. Por ello, si la asociación con este sector se debiera únicamente a un fenómeno meteorológico regional, se esperaría un comportamiento similar en todas. La ubicación aproximada del centroide no modifica esta clasificación: al desplazarlo 1.5 km en cada dirección, el azimut desde SE3 permanece dentro del rango ENE-ESE.
...
Los registros fuera de los rangos de validación proporcionados por SIMA se transformaron en valores faltantes. Debido a cambios en la instrumentación, estos límites varían según el año, por lo que la validación se realizó considerando simultáneamente año y variable.
